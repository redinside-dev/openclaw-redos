# Daily Portfolio Review — 2026-02-24

> **Style:** Executive brief (McKinsey-style)
...
- **Fed/rate path ambiguity**: tariff policy reintroduces upside inflation risk, reducing certainty around the Fed's trajectory. Long-duration assets (AI winners, growth stocks) face pressure.
- **Cross-asset positioning**: defensives, quality, and real assets tending to outperform high-beta, unprofitable growth, and levered proxies.

**PM takeaway:** maintain equity exposure but **manage the tails**. Reduce concentration in crowded high-volatility AI/semiconductor positions; rotate toward **quality, defensives, and ballast assets**. Keep core mega-cap compounders but at lower concentration levels.
...
- **AMZN — Neutral:** Quality franchise, but discretionary/cyclical exposure creates volatility in macro shocks.
- **BLK — Favored:** Quality financial with scale and franchise strength. Benefits if risk sentiment stabilizes.
...
- **VDY — Favored/Neutral:** Income/quality tilt. Helps dampen portfolio volatility.
- **VRE — Neutral/Disfavored:** REITs can struggle if rates move unpredictably. Keep small until rate path clearer.
- **XHU — Neutral:** Broad U.S. exposure. Fine as core but overlaps with SPY/VFV.

### Broad index exposure (good core)
- **SPY / VFV — Favored:** Core beta exposure. Prefer these over idiosyncratic single-name risk.
...
**Reduce (trim back):**
- NVDA (manage concentration risk; keep as tactical core)
- SOXX/SMH (reduce broad semi exposure)
- COIN, MSTR, ETHX.B (reduce crypto beta)
- TSLA (trim or exit unless high conviction)
- China complex: BABA, PDD, FXI, ZID
- QQQ/tech-tilt overlap: MGK, QQQM, XQQ, QQC (consolidate to reduce duplication)

**Hold / keep core:**
- MSFT, GOOGL (quality mega-cap defensives)
- META, AAPL, AMZN (watch these for rotation signals)
- BLK, NDAQ (quality financial infra)

### B) Rotate into ballast + defensives (deploy proceeds)
**Increase core beta (clean exposure):**
- SPY/VFV (choose one primary to reduce overlap)
- XEQT if you want global diversification

**Add defensives:**
- Staples/healthcare/utilities exposure: **XLP, XLV, XLU** or Canadian equivalents
- Low-vol quality: **USMV / SPLV** to reduce drawdown propensity

**Add real-asset hedge:**
- **IAU/GLD** (or add to existing RGLD) as tariff/geopolitical hedge

**Add cash-like / short duration:**
- **SGOV/BIL/SHY** or CAD cash/short-term ETF to improve optionality and dry powder
...
- If maintaining crypto exposure, treat it as high-volatility satellite position, not core.
...
- **COST** — Staples/retail quality with pricing power and recurring revenue
- **WMT** — Defensive retail with secular tailwinds in e-commerce and omnichannel
- **UNH / LLY** — Healthcare quality (choose based on valuation/positioning; UNH = defensive, LLY = secular growth)
- **V / MA** — High-quality payments duopoly with network effects and secular tailwinds

### Defense / geopolitical hedge
- **GD / NOC** — Complements existing LMT exposure for geopolitical hedge

### Energy / real assets (inflation hedge)
- **XLE** — Sector ETF for energy exposure (or select quality integrated names like XOM, CVX)

### Volatility dampeners / portfolio construction tools
- **USMV / SPLV** — Equity low-volatility strategies to reduce portfolio drawdowns
- **SGOV / SHY** — Short duration Treasuries for ballast and optionality
- **IAU/GLD** — Gold ETF to complement RGLD and strengthen real-asset hedge

### If you still want "AI exposure," prefer less crowded implementations:
- Keep a **smaller NVDA** position + broaden with **MSFT/GOOGL** rather than doubling down on semi ETFs + crowded single names.
...
**Disclaimer:** This analysis is for informational purposes only and does not constitute investment advice. All recommendations are framed as a hypothetical professional model portfolio. No guarantees of performance are expressed or implied. Past performance does not guarantee future results.
